...
public class SavedGYSJobModel {
    ...
    // Getters and setters omitted for brevity (can generate on request)
    ...
    public SavedGYSJobResponse createResponse() {
        SavedGYSJobResponse response = new SavedGYSJobResponse();
